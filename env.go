...
var Global_ atomic.Int64

func GetGlobalCount() int64 {
	return Global_.Load()
}
...
func (env Env) GetPStringUTF(ptr Jstring) *string {
	if ptr == 0 {
		return nil
	}
	jstr := C.jstring(ptr)
...
func (env Env) FindClass(name string) mo.Result[Jclass] {
	cstr_name := C.CString(name)
	defer C.free(unsafe.Pointer(cstr_name))
	var result = Jclass(C.FindClass((*C.JNIEnv)(unsafe.Pointer(env)), cstr_name))
	if result == 0 {
		if env.ExceptionCheck() {
			return mo.Errf[Jclass](env.GetAndClearExceptionMessage())
		}
	}
	return mo.Ok(result)
}
...
func (env Env) FromReflectedMethod(method Jobject) mo.Result[JmethodID] {
	if method == 0 {
		return mo.Errf[JmethodID]("obj==0")
	}
	r := JmethodID(unsafe.Pointer(C.FromReflectedMethod((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(method))))
	if r == 0 {
		if env.ExceptionCheck() {
			return mo.Errf[JmethodID](env.GetAndClearExceptionMessage())
		}
	}
	return mo.Ok(r)
}
...
func (env Env) NewGlobalRef(lobj Jobject) Jobject {
	r := Jobject(C.NewGlobalRef((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(lobj)))
	if r == 0 {
		if env.ExceptionCheck() {
			panic(errors.New(env.GetAndClearExceptionMessage()))
		} else {
			panic(errors.New("NewGlobalRef fail"))
		}
	}
	Global_.Add(1)
	return r
...
func (env Env) DeleteLocalRef(obj Jobject) mo.Result[struct{}] {
...
func (env Env) NewObjectA(clazz Jclass, methodID JmethodID, args ...Jvalue) mo.Result[Jobject] {
	x := Jobject(C.NewObjectA((*C.JNIEnv)(unsafe.Pointer(env)), C.jclass(clazz), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[Jclass](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(x)
...
func (env Env) GetObjectClass(obj Jobject) mo.Result[Jclass] {
	x := Jclass(C.GetObjectClass((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj)))
	if x == 0 {
		if env.ExceptionCheck() {
			return mo.Errf[Jclass](env.GetAndClearExceptionMessage())
		} else {
			return mo.Err[Jclass](errors.New("GetObjectClass fail"))
		}
	}
	return mo.Ok(x)
}
...
func (env Env) GetMethodID(clazz Jclass, name string, sig string) mo.Result[JmethodID] {
	cstr_name := C.CString(name)
	defer C.free(unsafe.Pointer(cstr_name))
	cstr_sig := C.CString(sig)
	defer C.free(unsafe.Pointer(cstr_sig))
	x := JmethodID(unsafe.Pointer(C.GetMethodID((*C.JNIEnv)(unsafe.Pointer(env)), C.jclass(clazz), cstr_name, cstr_sig)))
	if x == 0 {
		return mo.Errf[JmethodID](fmt.Sprintf("GetMethodID is nil,env:%v,cls:%v,name:%v,sig:%v", env, clazz, name, sig))
	}
	return mo.Ok(x)
}

func (env Env) CallObjectMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[Jobject] {
	if obj == 0 {
		return mo.Errf[Jobject]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[Jobject]("methodID==nil")
	}
	r := Jobject(C.CallObjectMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[Jobject](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallBooleanMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[bool] {
	if obj == 0 {
		return mo.Errf[bool]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[bool]("methodID==nil")
	}
	r := C.CallBooleanMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)) != C.JNI_FALSE
	if env.ExceptionCheck() {
		return mo.Errf[bool](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallByteMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[byte] {
	if obj == 0 {
		return mo.Errf[byte]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[byte]("methodID==nil")
	}
	r := byte(C.CallByteMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[byte](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallCharMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[uint16] {
	if obj == 0 {
		return mo.Errf[uint16]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[uint16]("methodID==nil")
	}
	r := uint16(C.CallCharMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[uint16](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallShortMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[int16] {
	if obj == 0 {
		return mo.Errf[int16]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[int16]("methodID==nil")
	}
	r := int16(C.CallShortMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[int16](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallIntMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[int] {
	if obj == 0 {
		return mo.Errf[int]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[int]("methodID==nil")
	}
	r := int(C.CallIntMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
...
func (env Env) CallLongMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[int64] {
	if obj == 0 {
		return mo.Errf[int64]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[int64]("methodID==nil")
	}
	r := int64(C.CallLongMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
...
func (env Env) CallFloatMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[float32] {
	if obj == 0 {
		return mo.Errf[float32]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[float32]("methodID==nil")
	}
	r := float32(C.CallFloatMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[float32](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallDoubleMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[float64] {
	if obj == 0 {
		return mo.Errf[float64]("obj==nil")
	}
	if methodID == 0 {
		return mo.Errf[float64]("methodID==nil")
	}
	r := float64(C.CallDoubleMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[float64](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
}

func (env Env) CallVoidMethodA(obj Jobject, methodID JmethodID, args ...Jvalue) mo.Result[struct{}] {
	if obj == 0 {
		return mo.Err[struct{}](errors.New("obj==nil"))
	}
	if methodID == 0 {
		return mo.Err[struct{}](errors.New("methodID==nil"))
	}
	C.CallVoidMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jobject(obj), C.jmethodID(unsafe.Pointer(methodID)), cvals(args))
	if env.ExceptionCheck() {
		return mo.Err[struct{}](errors.New(env.GetAndClearExceptionMessage()))
	}
	return mo.Ok(struct{}{})
}
...
func (env Env) GetStaticMethodID(clazz Jclass, name string, sig string) mo.Result[JmethodID] {
	cstr_name := C.CString(name)
	defer C.free(unsafe.Pointer(cstr_name))
	cstr_sig := C.CString(sig)
	defer C.free(unsafe.Pointer(cstr_sig))
	methodId := JmethodID(unsafe.Pointer(C.GetStaticMethodID((*C.JNIEnv)(unsafe.Pointer(env)), C.jclass(clazz), cstr_name, cstr_sig)))
	if methodId == 0 {
		return mo.Errf[JmethodID]("methodid ==0")
	}
	return mo.Ok(methodId)
}

func (env Env) CallStaticObjectMethodA(clazz Jclass, methodID JmethodID, args ...Jvalue) mo.Result[Jobject] {
	r := Jobject(C.CallStaticObjectMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jclass(clazz), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)))
	if env.ExceptionCheck() {
		return mo.Errf[Jobject](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
...
func (env Env) CallStaticBooleanMethodA(clazz Jclass, methodID JmethodID, args ...Jvalue) mo.Result[bool] {
	r := C.CallStaticBooleanMethodA((*C.JNIEnv)(unsafe.Pointer(env)), C.jclass(clazz), C.jmethodID(unsafe.Pointer(methodID)), cvals(args)) != C.JNI_FALSE
	if env.ExceptionCheck() {
		return mo.Errf[bool](env.GetAndClearExceptionMessage())
	}
	return mo.Ok(r)
...
func (env Env) GetAndClearExceptionMessage() string {
	excp := env.ExceptionOccurred()
	env.ExceptionClear()
	message := env.CallObjectMethodA(
		excp,
		env.GetMethodID(env.GetObjectClass(excp).MustGet(), "getMessage", "()Ljava/lang/String;").MustGet()).MustGet()
	return string(env.GetStringUTF(message))
}
...
func cmem(b []byte) *C.char {
	...
	//return (*C.char)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(&b[0]))))
}
...
func cvals(v []Jvalue) *C.jvalue {
	...
	return (*C.jvalue)(unsafe.Pointer(&v[0]))
}

func cBooleanArray(a []bool) *C.jboolean {
	return (*C.jboolean)(unsafe.Pointer(&a[0]))
}

func cByteArray(a []byte) *C.jbyte {
	return (*C.jbyte)(unsafe.Pointer(&a[0]))
}

func cShortArray(a []int16) *C.jshort {
	return (*C.jshort)(unsafe.Pointer(&a))
}

func cCharArray(a []uint16) *C.jchar {
	return (*C.jchar)(unsafe.Pointer(&a[0]))
}

func cIntArray(a []int32) *C.jint {
	return (*C.jint)(unsafe.Pointer(&a[0]))
}

func cLongArray(a []int64) *C.jlong {
	return (*C.jlong)(unsafe.Pointer(&a[0]))
}

func cFloatArray(a []float32) *C.jfloat {
	return (*C.jfloat)(unsafe.Pointer(&a[0]))
}

func cDoubleArray(a []float64) *C.jdouble {
	return (*C.jdouble)(unsafe.Pointer(&a[0]))
}

func AndroidLogError(tag, format string, v ...any) {
	ctag := CString(tag)
	cstr := CString(fmt.Sprintf(format, v...))
